...
import 'package:frontend/view_models/project.view_model.dart' as _i17;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factoryParam<_i17.ProjectViewModel, _i18.BuildContext, dynamic>((
      context,
      _,
    ) =>
        _i17.ProjectViewModel(
          context,
    ...
    gh.factoryParam<_i20.TagViewModel, _i18.BuildContext, dynamic>((
      context,
      _,
    ) =>
        _i20.TagViewModel(
    ...
    gh.factoryParam<_i22.TaskViewModel, _i18.BuildContext, bool>((
      context,
      _isEdit,
    ) =>
        _i22.TaskViewModel(
    ...
    gh.factoryParam<_i24.UserViewModel, _i18.BuildContext, dynamic>((
      context,
      _,
    ) =>
        _i24.UserViewModel(
    ...
    gh.factoryParam<_i26.AuthViewModel, _i18.BuildContext, dynamic>((
      context,
      _,
    ) =>
        _i26.AuthViewModel(
    ...
    gh.factoryParam<_i27.EditUserDialogViewModel, _i18.BuildContext, dynamic>((
      context,
      _,
    ) =>
    ...
    gh.factoryParam<_i28.LoginViewModel, _i18.BuildContext, dynamic>((
      context,
      _,
    ) =>
        _i28.LoginViewModel(
    ...
    gh.factoryParam<_i29.ProjectDialogViewModel, _i18.BuildContext,
        _i30.Project?>((
      context,
      _project,
    ) =>
    ...
    gh.factoryParam<_i31.RegisterViewModel, _i18.BuildContext, dynamic>((
      context,
      _,
    ) =>
    ...
    gh.factoryParam<_i32.TagDialogViewModel, _i18.BuildContext, _i33.Tag?>((
      context,
      _tag,
    ) =>
    ...
    gh.factoryParam<_i34.TaskListViewModel, _i18.BuildContext, dynamic>((
      context,
      _,
    ) =>
